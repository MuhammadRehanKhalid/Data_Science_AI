...
SPECIES: list[str] = [
    ...
    "Chromochloris zofingiensis",  # Formerly: Chlorella zofingiensis (can have green/orange pigment variants)
    "Spirulina major",
    "Alaria esculenta",
...
PHYLA: dict[str, str] = {
    ...
    "Chromochloris zofingiensis":              "Chlorophyta",
...
SPECIES_BASELINE: dict[str, float] = {
    ...
    "Chromochloris zofingiensis":              0.66,
